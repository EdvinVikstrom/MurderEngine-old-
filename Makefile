...
INCD = 
DEFS = -DDEBUG -DME_USE_TYPE_FLOAT 
LIBS = -lglfw -lGLEW -lGL -lGLU -lvulkan -lportaudio 

$(OUTD)/%.o: %.cpp $(SRC)
	$(CC) -c -o $@ $< $(INCD) $(CFLAGS) $(DEFS)
